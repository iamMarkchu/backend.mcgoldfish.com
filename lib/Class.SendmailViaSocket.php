...
function postmail($to,$subject = "",$body = "", $mailtype){
        ...
        $smtpserver = "www.couponsnapshot.com";                    #SMTP服务器地址
        $smtpserverport =25;                                    #SMTP服务器端口,E-mail是25
        $smtpusermail = "info@couponsnapshot.com";             #SMTP服务器的用户邮箱，这是用126测试
...
$to = "gree_cherry_lu@hotmail.com";    #收件人
$subject = "你好php mail test";   #标题
$body = "这是一封测试邮件";                          #内容
$mailtype = "HTML";      #邮件类型html or txt
$to = "info@couponsnapshot.com";
