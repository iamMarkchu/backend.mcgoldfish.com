        ...
        <div class="portlet box <?php echo (C("PORLET_COLOR")); ?>">
            ...
            <div class="portlet-body">
                <div class="row-fluid">
                    <div class="span12">
                        <!-- BEGIN FORM-->
                            <form action="<?php echo U('SiteConfig/[actionInsert]');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-actions">
                                    <button type="submit" class="btn blue">
                                        <?php echo (C("SAVE_BUTTON")); ?></button>
                                    <a href="<?php echo U('SiteConfig/index');?>" class="btn"><?php echo (C("CANCEL_BUTTON")); ?></a>
                                </div>
                            </form>
                            <!-- END FORM-->
                    </div>
