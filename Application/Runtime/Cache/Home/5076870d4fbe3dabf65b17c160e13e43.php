            ...
            <div class="portlet-body form">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="tab-pane">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo U('/Home/Category/insert');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?php echo U('/Home/Category/index');?>" class="btn">取消</a>
                                </div>
                            </form>
                            <!-- END FORM-->
                        </div>
