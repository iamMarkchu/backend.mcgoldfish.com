        ...
        <div class="portlet box <?php echo (C("PORLET_COLOR")); ?>">
            ...
            <div class="portlet-body form" >
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <div class="controls">
                            <input type="text" id="search_id_or_title" name="search_id_or_title" class="m-wrap medium" placeholder="" />
                        </div>
                    </div>
                    <div class="span2">
                        <div class="btn-group">
        ...
        <div class="portlet box <?php echo (C("PORLET_COLOR")); ?>">
            ...
            <div class="portlet-body">
                <div class="row-fluid">
                    <div class="span12">
                         <div class="btn-group">
                            <button class="btn green" id="add"><?php echo (C("ADD_BUTTON")); ?>组别</button>
                         </div>
                    </div>
                </div>
