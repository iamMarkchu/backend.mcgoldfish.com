    ...
    <div class="span12">
        <div class="portlet box <?php echo (C("PORLET_COLOR")); ?>">
            <div class="portlet-title">
                <div class="caption">
                    <?php echo (C("ADD_BUTTON")); echo ($conInfo["remark"]); ?>
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <div class="row-fluid">
                    <div class="span12">
                        <form action="<?php echo U('Article/insert');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div class="tabbable tabbable-custom">
                            ...
                            <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1_1">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <img id="imghead" src="" <?php if(empty($result["image"])): ?>class="hidden"<?php endif; ?>/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                       ...
                                       <div class="control-group">
                                            ...
                                            <div class="controls tagclass">
                                                <select multiple="multiple" id="tag_multi_select2" data-placeholder="标签选择" class="chosen span3 chzn-done" tabindex="-1"  name="tag_multi_select2[]">
                                                    <?php if(is_array($allTagInfo)): $i = 0; $__LIST__ = $allTagInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>' ><?php echo ($vo["displayname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select data-placeholder="分类选择" class="chosen span3 chzn-done" tabindex="-1" id="selOY2" name="categoryid" style="display: none;">
                                                    <option></option>
                                                    <?php if(is_array($allCateInfo)): $i = 0; $__LIST__ = $allCateInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><optgroup label="<?php echo ($vo["displayname"]); ?>" data-id="<?php echo ($vo["id"]); ?>">
                                                            <?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vovo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vovo["id"]); ?>' ><?php echo ($vovo["displayname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <div class="form-actions">
                                    <button type="submit" class="btn blue"><?php echo (C("SAVE_BUTTON")); ?></button>
