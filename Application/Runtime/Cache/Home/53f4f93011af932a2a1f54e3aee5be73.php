            ...
            <div class="portlet-body form">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="tab-pane">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo U('/Home/Category/update');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                <div class="hidden">
                                ...
                                <div class="control-group">
                                        <label class="control-label">
                                            displayname</label>
                                    <div class="controls">
                                        <input type="text" placeholder="displayname" class="m-wrap medium"  name="displayname" value="<?php echo ($result["displayname"]); ?>" />
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="parentcategoryid" class="m-wrap medium" name="parentcategoryid" value="<?php echo ($result["parentcategoryid"]); ?>"/>
                                 ...
                                 <div class="control-group">
                                        <label class="control-label">
                                            displayorder</label>
                                    <div class="controls">
                                        <input type="text" placeholder="displayorder" class="m-wrap medium" name="displayorder" value="<?php echo ($result["displayorder"]); ?>" />
                                        <span class="help-inline"></span>
                                    </div>
                                 </div>
