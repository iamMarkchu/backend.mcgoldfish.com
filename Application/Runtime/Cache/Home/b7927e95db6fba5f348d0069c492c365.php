            ...
            <div class="portlet-body form">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="tab-pane">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo U('/Home/Article/update');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                <div class="hidden">
                                 ...
                                 <div class="control-group">
                                        <label class="control-label">
                                            文章标题</label>
                                    <div class="controls">
                                        <input type="text" placeholder="文章标题" class="m-wrap medium" value="<?php echo ($result["title"]); ?>"  name="title" />
                                 ...
                                 <div class="control-group">
                                        <label class="control-label">
                                            网页H1</label>
                                    <div class="controls">
                                        <input type="text" placeholder="网页H1" class="m-wrap medium" value="<?php echo ($result["pageh1"]); ?>" name="pageh1" />
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="articlesource">
                                            <option  <?php if(($$result["articlesource"]) == "原创"): ?>selected="selected"<?php endif; ?>>原创</option>
                                            <option <?php if(($$result["articlesource"]) == "转载"): ?>selected="selected"<?php endif; ?>>转载</option>
                                        </select>
                                        <span class="help-inline"></span>
                                    </div>
                                 </div>
                                  <div class="control-group">
                                        <label class="control-label">
                                            文章内容</label>
                                    <div class="controls">
                                        <textarea id="articleContent" name="content"><?php echo ($result["content"]); ?></textarea>
                                    </div>
                                 </div>
                                <div class="control-group">
                                        <label class="control-label">
                                            维护等级</label>
                                    <div class="controls">
                                        <input type="text" placeholder="维护等级" class="m-wrap small" id="maintainorder" name="maintainorder" value="<?php echo ($result["maintainorder"]); ?>" />
