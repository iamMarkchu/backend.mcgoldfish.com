    ...
    var TagindexManager = {
                ...
                "columns": [
                    ...
                    { "data": "id",
                      "render": function (data, type, row) {
                            return '<a href="/Home/Tag/edit/id/'+data+'" class="edit">编辑</a>|<a href="/Home/Tag/delete/id/'+data+'" class="delete">删除</a>'; 
                        }
                    }
                ]
            });
        ...
        bindEvent: function () {
            ...
            $('#addTag').click(function(e){
                window.location.href="/Home/Tag/add/";
            });
