    ...
    var NodeIndexManager = {
                ...
                "columns": [
                    { "data": "id",
                      "render": function (data, type, row) {
                            return '<div class="btn-group"><a class="btn purple" href="#" data-toggle="dropdown">'+data+'</a><ul class="dropdown-menu"><li><a href="/Home/Node/edit/id/'+data+'"><i class="icon-trash"></i> Edit</a></li><li><a href="/Home/Auth/delete/id/'+data+'"><i class="icon-remove"></i> Delete</a></li><li><a href="/Home/Node/index/pid/'+data+'"><i class="icon-add"></i> childList</a></li></ul></div>';
        ...
        bindEvent: function () {
            ...
            $('#addNode').click(function(e){
                window.location.href="/Home/Node/add/";
            });
